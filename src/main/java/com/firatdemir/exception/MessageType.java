...
public enum MessageType {
	...
	REFRESH_TOKEN_NOT_FOUND("1008", "refresh token bulunamadı"),REFRESH_TOKEN_IS_EXPIRED("1009","refres tokenın süresi bitmiştir"), GENERAL_EXCEPTION("9999", "genel bir hata oluştu");
